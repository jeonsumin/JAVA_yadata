...
public class setlogin extends JFrame implements ActionListener {
	set set=new set();
	// 패널생성
	...
	private JLabel logo = new JLabel(new ImageIcon("./src/images/set_logo1.PNG"));
